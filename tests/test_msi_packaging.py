...
def test_release_workflow_publishes_only_versioned_public_assets():
    ...
    assert "AUTODY_RELEASE_VERSION: \"1.5.1\"" in workflow
    ...
    for asset in [
        "output/release/v1.5.1/AutoDy-1.5.1-x64.msi",
        "output/release/v1.5.1/AutoDy-1.5.1-x64.msi.sha256",
        "output/release/v1.5.1/AutoDy-Windows-Portable-1.5.1.zip",
        "output/release/v1.5.1/AutoDy-Windows-Portable-1.5.1.zip.sha256",
        "output/release/v1.5.1/release-manifest.json",
    ]:
