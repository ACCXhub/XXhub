...
test("refreshes the overview resource count immediately after a friend mutation", async () => {
  const status = (count: number) => ({
    ...
    statistics: {
      ...
      success_rate_30d: 0, retries_7d: 0, successful_today: 0, failed_today: 0,
  ...
  apiMocks.config.mockResolvedValue({
    ...
    message_pack_index_url: null, daily_send_time: "07:30", daily_health_check_time: "07:20",
    weekly_health_check_enabled: true, weekly_health_check_weekday: "Sunday",
    weekly_health_check_time: "20:00", startup_recovery_enabled: true,
