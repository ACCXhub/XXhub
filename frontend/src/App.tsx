...
export default function App() {
  ...
  return (
    <div className="app-shell">
      <Sidebar active={view === "test-center" ? "settings" : view} onChange={setView} account={account} onRefreshAccount={() => void refreshAccount()} testCenterInstalled={testCenterInstalled} testCenterActive={view === "test-center"} onOpenTestCenter={() => setView("test-center")} />
